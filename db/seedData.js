  ...
  try {
    ...
    const productsToCreate = [
      ...
      },
      {
        ...
        artist: "Keshi",
        description:
          '"Always", stylized as "always", is the fourth extended play (EP) by American singer-songwriter keshi. It was released through Island Records on October 23rd, 2020.',
        price: 15.99,
...
async function createInitialProductCategories() {
  try {
    console.log(
      "Starting to create product categories i.e. attach categories to products"
    );
    ...
    const productCategories = await Promise.all(
      productCategoriesToCreate.map(addCategoryToProduct)
    );
